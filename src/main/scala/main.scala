...
object Main extends App with ChiselSim {
	//ChiselStage.emitSystemVerilogFile(new BurstLooseWriter (32,20,10,10), firtoolOpts = Array("-strip-debug-info", "--disable-all-randomization","-default-layer-specialization=enable"))
	...
	println("----------------------")
	simulateRaw((new BurstInOut(32,10,10,20,10))) { dut =>
		enableWaves()
		ResetProcedure.module()(dut)
		//RunUntilFinished(1000)(dut)
		var validReadCnt=0
	...
	println("----------------------")
	simulateRaw((new BurstInOut(32,20,10,10,10))) { dut =>
		enableWaves()
		ResetProcedure.module()(dut)
		//RunUntilFinished(1000)(dut)
		var validReadCnt=0
	...
	*/
	...
	println("----------------------")
	simulateRaw((new BurstInOut_Rand(32,20,10,10,10))) { dut =>
		enableWaves()
		ResetProcedure.module()(dut)
		//RunUntilFinished(1000)(dut)
		var validReadCnt=0
	...
	println("----------------------")
	simulateRaw((new BurstInOut_Rand(32,10,10,20,10))) { dut =>
		enableWaves()
		ResetProcedure.module()(dut)
		//RunUntilFinished(1000)(dut)
		var validReadCnt=0
